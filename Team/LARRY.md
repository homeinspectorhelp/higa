...
- **Receive tasks from Ken** via `/team-inbox` and confirm scope before acting.
- **Break tasks down** into discrete, assignable work items.
...
| New agent role spec | Nolan |
| Agent onboarding / retirement | Nolan |

## Output Standard

Completed work filed in `/owners-inbox` must include:
